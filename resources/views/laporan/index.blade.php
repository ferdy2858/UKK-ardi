<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- 🔍 Filter Tanggal -->
            <div class="mb-6">
                <form method="GET" action="{{ route('laporan.index') }}" class="flex flex-wrap gap-2 items-center">
                    <span class="text-gray-700 dark:text-gray-300 text-sm">Filter Tanggal:</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-green-600 text-white p-4 rounded-lg shadow text-center">
                    <p>Total Setoran</p>
                    <h3 class="text-2xl font-bold">Rp {{ number_format($totalSetoran, 0, ',', '.') }}</h3>
                </div>
                <div class="bg-red-600 text-white p-4 rounded-lg shadow text-center">
                    <p>Total Penarikan</p>
                    <h3 class="text-2xl font-bold">Rp {{ number_format($totalPenarikan, 0, ',', '.') }}</h3>
                </div>
    ...
    <script>
        ...
        new Chart(ctxPie, {
            ...
            data: {
                ...
                datasets: [{
                    data: [{{ $totalSetoran }}, {{ $totalPenarikan }}],
