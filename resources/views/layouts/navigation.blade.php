                            ...
                            <a href="{{ route('dashboard') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120"
                                    ...
                                    <g fill="none" fill-rule="evenodd">
                                        <path d="M60 6 L100 22 v30 c0 28-20 48-40 56-20-8-40-28-40-56V22z"
                                            fill="url(#gA)" />
                                        <circle cx="60" cy="60" r="18" fill="#fff" />
                                        <path d="M60 50c6 0 10 4 10 10s-4 10-10 10-10-4-10-10 4-10 10-10z"
                                            fill="#f59e0b" />
                                        <path d="M45 40 L75 40 L60 30z" fill="#07203a" />
                                        <rect x="52" y="42" width="16" height="4" rx="2"
                                            fill="#07203a" />
                                    </g>
                                </svg>
                            </a>
